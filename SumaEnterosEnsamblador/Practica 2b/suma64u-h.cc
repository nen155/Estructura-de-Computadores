...
unsigned long long int suma64u(unsigned int v[], int n)
{
...
{
	resultado = suma64u(v, N);
	std::cout << "suma64u    = " << resultado << std::endl;
	...
	resultado = 0;
	resultado = std::accumulate(&v[0], &v[0] + N, resultado);
